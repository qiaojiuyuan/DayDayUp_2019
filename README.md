...
2.高用init方法初始化对象有可能失败，如果初始化失败，返回的就是nil
...
调用的时候要新调用alloc方法来创建对象，再调用初始化方法
如
...
不会在delloc中生成relase代码，所以我们必须要手动的在dealloc中使用
release方法
